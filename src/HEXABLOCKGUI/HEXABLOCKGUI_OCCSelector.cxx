...
// File   : HEXABLOCKGUI_OCCSelector.cxx
//
...
//================================================================
// Function : HEXABLOCKGUI_OCCSelector
// Purpose  :
//================================================================
HEXABLOCKGUI_OCCSelector::HEXABLOCKGUI_OCCSelector( OCCViewer_Viewer* viewer, SUIT_SelectionMgr* mgr )
...
// Purpose  :
//================================================================
HEXABLOCKGUI_OCCSelector::~HEXABLOCKGUI_OCCSelector()
{
}
...
// Purpose  :
//================================================================
void HEXABLOCKGUI_OCCSelector::getSelection( SUIT_DataOwnerPtrList& aList ) const
{
  ...
  for (anExtIter = mySelectedExternals.begin(), itEnd = mySelectedExternals.end(); anExtIter != itEnd; anExtIter++)
  {
...
// Purpose  :
//================================================================
void HEXABLOCKGUI_OCCSelector::setSelection( const SUIT_DataOwnerPtrList& aList )
{
  OCCViewer_Viewer* vw = viewer();
  if ( !vw )
    return;
  ...
  for ( SUIT_DataOwnerPtrList::const_iterator itr = aList.begin(), itEnd = aList.end(); itr != itEnd; ++itr )
  {
  ...
  for ( SUIT_DataOwnerPtrList::const_iterator itr2 = aList.begin(), itEnd = aList.end(); itr2 != itEnd; ++itr2 )
  {
